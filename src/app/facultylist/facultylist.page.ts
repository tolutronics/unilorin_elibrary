...
@Component({
  ...
  templateUrl: './facultylist.page.html',
  styleUrls: ['./facultylist.page.scss'],
})
...
public devWidth = this.platform.width();
  constructor(public activatedRoute:ActivatedRoute, private postPvdr:PostProvider,private alertController: AlertController,public router:Router, public platform:Platform, public ps:PassageService) { 
